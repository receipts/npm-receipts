...
var getLotteryTicketsCollectionV1 = function getLotteryTicketsCollectionV1(req, res, next) {
  ...
  return receipts.getLotteryTicketsCollection(id, authRequest, options, function (err, data) {
    if (err) {
    ...
    return async.map(uniqData, buildTicketResponse, function (asyncErr, tickets) {
...
var createLotteryTicketV1 = function createLotteryTicketV1(req, res, next) {
  ...
  return receipts.createLotteryTicket(lotteryId, ticketRequest, options, function (err, data) {
    if (err) {
      keen.errorEvent(req.authorization.bearer, {}, err);
    }
...
var getLotteryTicketV1 = function getLotteryTicketV1(req, res, next) {
  ...
  return receipts.getLotteryTicket(id, ticketId, authRequest, options, function (err, data) {
    if (err) {
      keen.errorEvent(req.authorization.bearer, {}, err);
    }
    ...
    return buildTicketDetailsResponse(data, function (buildErr, ticket) {
...
var updateLotteryTicketV1 = function updateLotteryTicketV1(req, res, next) {
  ...
  return receipts.updateLotteryTicket(lotteryId, ticketId, authRequest, updateTicketRequest, options, function (err, data) {
    if (err) {
      keen.errorEvent(req.authorization.bearer, {}, err);
    }
