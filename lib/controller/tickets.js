...
var getLotteryTicketsCollectionV1 = function getLotteryTicketsCollectionV1(req, res, next) {
  ...
  receipts.getLotteryTicketsCollection(id, authRequest, options, function (err, data) {
    ...
    async.map(uniqData, buildTicketResponse, function (asyncErr, tickets) {
...
var getLotteryTicketV1 = function getLotteryTicketV1(req, res, next) {
  ...
  receipts.getLotteryTicket(id, ticketId, authRequest, options, function (err, data) {
    if (err) {
      keen.errorEvent(req.authorization.bearer, {}, err);
    }
    ...
    buildTicketDetailsResponse(data, function (buildErr, ticket) {
...
var updateLotteryTicketV1 = function updateLotteryTicketV1(req, res, next) {
  ...
  receipts.updateLotteryTicket(lotteryId, ticketId, authRequest, updateTicketRequest, options, function (err, data) {
    if (err) {
      keen.errorEvent(req.authorization.bearer, {}, err);
    }
