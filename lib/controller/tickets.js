...
var LotteryTicketsCollectionResponse = receiptsModel.lotteryTicketsCollectionResponse.LotteryTicketsCollectionResponse;
...
var getLotteryTicketsCollectionV1 = function getLotteryTicketsCollectionV1(req, res, next) {
  ...
  receipts.getLotteryTicketsCollection(id, limit, offset, sort, function (err, data) {
    ...
    var collection = new LotteryTicketsCollectionResponse()
      .withTotal(1)
      .withTickets([ticket])
      .build();
