...
var getLotteryResultsCollection = function getLotteryResultsCollection(id, callback) {
  ...
  results.push(
    new ResultResponseBuilder()
      .withName('Nagrody I stopnia: Opel Astra, iPad Air 2')
      .withDate(moment('2015-10-11T16:00:00.000Z').toISOString())
  ...
  results.push(
    new ResultResponseBuilder()
      .withName('Nagrody I stopnia: Opel Astra, iPad Air 2')
      .withDate(moment('2015-11-16T16:00:00.000Z').toISOString())
  ...
  results.push(
    new ResultResponseBuilder()
      .withName('Nagrody II stopnia: Notebook Lenovo, iPad Air 2')
      .withDate(moment('2015-11-27T16:00:00.000Z').toISOString())
      .withStatus(ResultStatus.ACTIVE)
      .withPrizes([
        new ResultPrizeResponseBuilder()
  ...
  results.push(
    new ResultResponseBuilder()
      .withName('Nagrody I stopnia: Opel Astra, iPad Air 2')
      .withDate(moment('2015-12-21T16:00:00.000Z').toISOString())
  ...
  results.push(
    new ResultResponseBuilder()
      .withName('Nagroda specjalna: Opel Insignia')
      .withDate(moment('2016-01-18T16:00:00.000Z').toISOString())
      .withStatus(ResultStatus.PENDING)
      .withPrizes([
        new ResultPrizeResponseBuilder()
