...
var getLotteryResultsCollection = function getLotteryResultsCollection(id, callback) {
        ...
        new ResultPrizeResponseBuilder()
          ...
          .withWinners([
            new ResultPrizeWinnerResponseBuilder()
              .withCode('C2R716HY2HG')
              .build(),
            new ResultPrizeWinnerResponseBuilder()
              .withCode('CUSRI6W5UZ8')
              .build(),
            new ResultPrizeWinnerResponseBuilder()
              .withCode('C6JF9FQVLNQ')
              .build(),
            new ResultPrizeWinnerResponseBuilder()
              .withCode('CL41QTEQPAH')
              .build(),
            new ResultPrizeWinnerResponseBuilder()
              .withCode('CG6GNGJBQGR')
              .build(),
            new ResultPrizeWinnerResponseBuilder()
              .withCode('CMM320EE6ZY')
              .build()
          ])
          .build(),
        new ResultPrizeResponseBuilder()
          ...
          .withWinners([
            new ResultPrizeWinnerResponseBuilder()
              .withCode('CT3XEAD2L5C')
              .build(),
            new ResultPrizeWinnerResponseBuilder()
              .withCode('C78UHVEA41P')
              .build(),
            new ResultPrizeWinnerResponseBuilder()
              .withCode('CM77R71G2I9')
              .build(),
            new ResultPrizeWinnerResponseBuilder()
              .withCode('CD4WYXYP8A3')
              .build(),
            new ResultPrizeWinnerResponseBuilder()
              .withCode('CQ1P1NPCHMX')
              .build()
          ])
          .build()
      ])
  ...
  results.push(
    new ResultResponseBuilder()
      .withName('Nagrody II stopnia')
      .withDate(moment('2016-02-26T20:00:00.000Z').toISOString())
      .withStatus(ResultStatus.ACTIVE)
      .withPrizes([
        new ResultPrizeResponseBuilder()
          .withName('Lenovo ThinkPad')
